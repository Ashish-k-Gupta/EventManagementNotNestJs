...
export class CategoryService {
    ...
    async createCategory(userId: string, createCategoryInput: CreateCategoryInput): Promise<Category> {
    ...
    async softRemoveCategory(categoryId: string): Promise<{ message: string }> {
